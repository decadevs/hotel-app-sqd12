...
<nav className='nav'>
    ...
    <div className="right-nav">
        ...
        <div className="name">
            {level.firstName} {level.lastName}
       ...
       <div className="dropdow-App">
            <div className="menu-container">
                <div className='menu-trigger' onClick={() => {setOpen(!open)}}>
                                 ...
                                 {/* <img  className='dropdownImg' src={level.avatar} style={{"width":"50px","border-radius":"50%"}} /> */}
                     </div>
                        <div className={`dropdown-menu ${open? 'active' : 'inactive'}`} >
                             <h3 className='dropdown-h3'>Profile<br/><span className='dropdown-span'>....</span>
                        </h3>
                         <ul className='dropdown-ul'>
                               {/* <DropdownItem img = {""} text = {"Picture"} />  */}
                               <DropdownItem img = {""} text = {"Profile"} /> 
                               <DropdownItem img = {""} text = {"Settings"} /> 
                               <Link to={"/login"}><DropdownItem img = {""} text = {"Sign out"} /></Link>
                        </ul>
                </div>
                </div>
        </div>
