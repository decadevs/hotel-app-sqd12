...
const CustomerDashboard = () => {
  ...
  const handlePrevClick = () => {
    setCurrentIndex(
      currentIndex === 0 ? hotelImages.length - 1 : currentIndex - 1
    );
  };

  const handleNextClick = () => {
    setCurrentIndex(
      currentIndex === hotelImages.length - 1 ? 0 : currentIndex + 1
    );
  };
  ...
  return (
    <div className="customer-dashboard-container">
      ...
      <div className="graph-container">
        ...
        <div className="graph">
          <img src={graph} alt="graph" id="sing" />
        </div>
      </div>
      <div className="bottom">
        <div className="calender">
          <img src={calender} alt="calender" id="calen" />
        </div>
